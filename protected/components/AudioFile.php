...
class AudioFile
{
	...
	{	
		...
		//print "<tr><td align=right>arquivo</td>		<td>&nbsp;$this->wave_filename</td></tr>";
		//print "<tr><td align=right>id</td>		<td>&nbsp;$this->wave_id</td></tr>";
		//print "<tr><td align=right>type</td>	<td>&nbsp;$this->wave_type</td></tr>";
		print "<tr style='background:#E5F1F4;'><td align=right>tamanho: </td>	<td>&nbsp;". number_format($this->wave_size/1024, 3) ." KBytes</td></tr>";
		print "<tr style='background:#F8F8F8;'><td align=right>compressão: </td>	<td>&nbsp;".$this->getCompression ($this->wave_compression)."</td></tr>";
		print "<tr style='background:#E5F1F4;'><td align=right>canais:</td>	<td>&nbsp;$this->wave_channels</td></tr>";
		print "<tr style='background:#F8F8F8;'><td align=right>framerate:</td>	<td>&nbsp;$this->wave_framerate</td></tr>";
		print "<tr style='background:#E5F1F4;'><td align=right>byterate:</td>	<td>&nbsp;$this->wave_byterate</td></tr>";
		print "<tr style='background:#F8F8F8;'><td align=right>bits:</td>	<td>&nbsp;$this->wave_bits</td></tr>";
		print "<tr style='background:#E5F1F4;'><td align=right>duração:</td>	<td>&nbsp;".number_format ($this->wave_length,"2")." seg. | ".date("i:s", mktime(0,0,round($this->wave_length)))."</td></tr>";
