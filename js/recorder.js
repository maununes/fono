...
{
  $('#status').text("Status do gravador: " + arguments[0]);
  ...
  case "recording":
    ...
    Recorder.hide();
    $('#record_button img').attr('src', '/fono/images/stop.png');
    $('#play_button').hide();
    break;
  ...
  case "recording_stopped":
    ...
    Recorder.show();
    $('#record_button img').attr('src', '/fono/images/record.png');
    $('#duration').text(duration.toFixed(4) + " segundos");
    $('#play_button').show();
    break;
  ...
  case "playing":
    var name = arguments[1];
    $('#record_button img').attr('src', '/fono/images/record.png');
    $('#play_button img').attr('src', '/fono/images/stop.png');
	$('#record_button').hide();
    break;
  ...
  case "stopped":
    var name = arguments[1];
    $('#record_button img').attr('src', '/fono/images/record.png');
    $('#play_button img').attr('src', '/fono/images/play.png');
	$('#record_button').show();
    break;
